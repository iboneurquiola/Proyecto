...
public class TresXUno extends Collage
{
	...
	public BufferedImage HacerCollage()
	{
		...
		iFinal = Collage.CopiarImagen(0,0,400,133 ,imagen1, iFinal);			
		iFinal = Collage.CopiarImagen(0,133,400,266, imagen2, iFinal);
		iFinal = Collage.CopiarImagen(0,266,400,400, imagen3, iFinal);
